...
$(document).ready(function () {
  $("#delivery").submit(function () {
      ...
      alert("Hello " + name + ". Your order has been successfuly received and will be delivered to " +  location + " within Two hours.The delivery will cost ksh 200/= Thank you for choosing the Krusty-Krab.");
      // $(this).get(0).reset();
      //  event.preventDefault();
  });
